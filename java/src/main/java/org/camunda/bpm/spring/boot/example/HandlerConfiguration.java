...
public class HandlerConfiguration {
  ...
  @ExternalTaskSubscription("motorjava")
  @Bean
  public ExternalTaskHandler loanGranter() {
    return (externalTask, externalTaskService) -> {


      LOG.info("{}: Iniciando Tarefa {} !", workerId, externalTask.getId());

      LOG.info("simulando um motor rodando");

      externalTaskService.complete(externalTask);

      LOG.info("{}: Tarefa Finalizada {} !", workerId, externalTask.getId());
